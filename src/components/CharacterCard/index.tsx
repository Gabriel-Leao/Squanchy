...
const unknownStatus =
  'bg-gray-500 text-[#fff] rounded-lg w-[140px] text-[20px] px-2'
const aliveStatus =
  'bg-[#008139] text-[#fff] rounded-lg w-[60px] text-[20px] px-2'
    ...
    <div className='p-2 flex flex-wrap max-w-[300px] cursor-pointer'>
      <Link href={`/character/${Character.id}`}>
        <div className='border-4 border-[#00B0C8] rounded-lg'>
          ...
          <h1 className='capitalze text-center text-[20px] pb-4'>
            {Character.name}
          </h1>
          <span className='capitalize ml-2 pb-3 text-left'>
            última localização:
          </span>
          <p className='capitalize ml-2 text-[18px] pb-4'>
